        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'catalogues' ? 'active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">E-Catalogue</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'menuSettings' ? 'active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">Menu Settings</span>
                </a>
            </li>
            <li class="nav-item">
