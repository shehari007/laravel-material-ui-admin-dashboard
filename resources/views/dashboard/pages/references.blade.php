<x-layout bodyClass="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="alert alert-secondary" role="alert" style="color: white;">
                ...
                <span class="alert-text"><strong>Careful!</strong> Only File Size Max 2MB and Images jpeg, png, jpg, gif and resolution of only 150x150 are accepted</span>
            </div>
            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteReferences"> <span class="material-icons">
                    delete
                </span>Delete All References</button>
            <div id="dropzone">
                <form class="dropzone" action="references/fileUploadRef" id="file-upload" enctype="multipart/form-data">
                    @csrf
            ...
            <div style="display: flex; flex-wrap: wrap;">
                    ...
                    <div class="card" data-animation="true" style="width: 100%; height: 100%;">
                        <div class="card-header p-0 position-relative mt-n3 mx-3 z-index-2">
                            <a class="d-block blur-shadow-image" style=" height: 180px; overflow: hidden;">
                                <img src="{{ asset('storage/References/Gallery/' . $reference->src) }}" width="150" height="150" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg" style="object-fit: fill; object-position: center center; width: 100%; height: 100%;">
                            </a>
                        ...
                        <div class="card-body text-center">
                            <div class="d-flex mx-auto" style="margin-top: -4.2rem;">
                                <button type="button" class="btn btn-danger text-light mx-auto border-0" data-bs-toggle="modal" data-bs-target="#deleteConfirmModalReference{{ $reference->id }}">
                ...
                <div class="modal fade" id="deleteConfirmModalReference{{ $reference->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteConfirmModalReferenceLabel{{ $reference->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="references/deletePhotoRef/{{ $reference->id }}">
                                    @csrf
                                    <div align="center">
                                        <img src="{{ asset('storage/References/Gallery/' . $reference->src) }}" width="150" height="150" alt="img-blur-shadow" />
            ...
            <div class="modal fade" id="deleteReferences" tabindex="-1" role="dialog" aria-labelledby="deleteReferencesLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Confirm Delete</h5>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="references/deleteGalleryRef">
                                @csrf
                                <div align="center">
