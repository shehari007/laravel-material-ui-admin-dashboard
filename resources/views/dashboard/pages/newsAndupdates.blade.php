<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            ...
            @endif
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addNewModal"><i class="material-icons">add</i>Add New News</button>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="align-middle text-center"><input type="checkbox" name="selected_rows[]" value="{{ $news->id }}"></td>
                                ...
                                <td class="align-middle text-center">
                                    ...
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteConfirmModal{{ $news->id }}">
                            ...
                            <div class="modal fade" id="deleteConfirmModal{{ $news->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteConfirmModalLabel{{ $news->id }}" aria-hidden="true">
                                ...
                                <div class="modal-dialog modal-dialog-centered" style="min-width: 80%;" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="margin-left: 20%;">
                                            <form role="form" class="form-vertical" id="tab1_form" method="POST" enctype="multipart/form-data" action="newsAndupdates/editNews/{{ $news->id }}">
                                                @csrf
    ...
    $(document).ready(function() {
        ...
        $("#delete-selected-button").click(function() {
            ...
            if (deleteSelected.length > 0) {
                $.ajax({
                    url: `newsAndupdates/deleteSelected/deleteCheckedNews`,
                    method: "POST",
                    data: {
                        ids: deleteSelected,
                        _token: '{!! csrf_token() !!}'
